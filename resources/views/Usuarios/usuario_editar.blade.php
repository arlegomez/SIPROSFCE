                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li><a href="{{ url ('home')}}"><i class="notika-icon notika-house"></i> Inicio</a>
                         ...
                         <li><a data-toggle="tab" href="#Usuarios"><i class="notika-icon notika-form"></i> Expediente</a>
                        </li>
                        <li><a data-toggle="tab" href="#Roles"><i class="notika-icon notika-edit"></i> Instituciones</a>
                        </li>
                    </ul>
                            ...
                            @csrf
                                ...
                                <div class="form-example-int mg-t-15">
                                    <div class="form-group">
                                        ...
                                        <div class="nk-int-st">
                                            <input name="name" id="name" type="text" class="form-control input-sm" placeholder="Nombre completo del usuario" value="{{old('nombre')}}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-example-int mg-t-15">
                                    <div class="form-group">
                                        ...
                                        <div class="nk-int-st">
                                            <input name="email" id="email" type="text" class="form-control input-sm" placeholder="Correo electrónico del usuario" value="{{old('email')}}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-example-int mg-t-15">
                                    <div class="form-group">
                                        ...
                                        <div class="nk-int-st">
                                            <input name="password" id="password" type="password" class="form-control input-sm" placeholder="Contraseña del usuario" value="{{old('password')}}" required>
                                        </div>
                                    </div>
                                </div>
